...
export const ReviewsDashboard2 = () => {
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 border-l-8 border-green-500">
          ...
          <p className="text-3xl font-bold text-gray-800">{uniqueReviewers}</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          ...
          <ResponsiveContainer width="100%" height={350}>
            <BarChart data={storeAvgRating} margin={{ left: 60 }}>
              ...
              <Tooltip formatter={(value) => formatRating(value)} />
              <Legend />
              <Bar dataKey="averageRating" fill="#EC4899" name="Avg Rating" />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </div>
