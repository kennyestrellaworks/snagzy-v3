                          ...
                          {variant.orders.length > 1 ? (
                            <div className="flex flex-col gap-2">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <p className="leading-tight text-[14px]">
                                  {totalUnsuccessfulItemsVariant} Cancelled
                                </p>
                              </div>
                            </div>
                          ) : null}
                        ...
                        variant.orders.map((variantItem, variantIndex) => {
                          return (
                            <div key={variantIndex}>
                              <div className="grid grid-cols-[2.4fr_3.6fr_1.6fr_1.2fr_1.6fr_.5fr] border-b border-gray-300 bg-white text-sm">
                                {/* Order details box  */}
