...
import { IoIosArrowDown, Search } from "../../components/SVG";
...
export const Products2 = () => {
  ...
  const handleStoreChange = (storeId) => {
    ...
    // Reset visible count when a filter changes and remove it from the URL
    setVisibleCountParams(count);
  ...
  useEffect(() => {
    ...
    const urlVisibleCount =
      parseInt(searchParams.get("visible_count"), 10) || count;
  ...
  useEffect(() => {
    ...
    // ensure visible_count is removed from the url when filters change
    const params = {};
