...
// Import uniform buttons matching Inventory.jsx design layout
...
export const Orders1 = () => {
  ...
  const updateOrderedItemCount = (orderId, newCount) => {
    ...
    if (newCount === INITIAL_ITEM_LIMIT) {
      // Remove key if it hits default limits to keep standard URLs cleaner
              ...
              {displayedOrders.map((displayedOrder, displayedOrderIndex) => {
                ...
                return (
                  <div
                    ...
                    className="grid grid-cols-[3fr_6fr_5fr] w-full text-sm border-b border-gray-300"
                  >
                    {/* Grid 1  */}
                    ...
                    {/* Grid 2  */}
                    <div className="flex flex-col justify-between h-full border-r border-gray-300">
                      {totalItems === 0 ? (
                        ...
                        <div className="flex flex-col h-full justify-between">
                                ...
                                return (
                                  <div
                                    ...
                                    className={`grid grid-cols-[6.6fr_1.6fr_.6fr_1.8fr] w-full ${
                                      orderedItemIndex < visibleItems.length - 1
                          ...
                          {/* Sub-item internal Load More / Less Pagination Actions */}
                          {showLoadMoreButton && (
                            <div className="flex items-center justify-center p-2 border-t border-gray-300 bg-gray-50 mt-auto">
                              <LoadMoreVariant
                                onClick={() => {
                                  if (isShowingAll) {
